...
__all__ = [
    'DISPID_SPIElements', 'DISPID_SDKOpenKey', 'DISPID_SPIGrammarId',
    'ISpeechResourceLoader', 'ISpeechMMSysAudio', 'SVP_12', 'SINone',
    'SpWaveFormatEx', 'SPEI_TTS_AUDIO_LEVEL', 'SP_VISEME_11',
    'DISPID_SpeechAudioFormat', 'DISPID_SOTGetStorageFileName',
    'eLEXTYPE_PRIVATE2', 'ISpPhrase', 'SAFT44kHz8BitMono',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SPRules_NewEnum',
    'SAFTCCITT_ALaw_44kHzStereo', 'SWTAdded', 'SRSActiveAlways',
    'SITooSlow', 'ISpeechLexiconWords', 'DISPID_SPEAudioStreamOffset',
    'SPAUDIOBUFFERINFO', 'DISPID_SOTCEnumerateTokens', 'SPFM_CREATE',
    'SPPS_NotOverriden', 'SPRST_ACTIVE_ALWAYS', 'SpeechVoicePriority',
    'SBONone', 'DISPID_SRCESoundStart', 'SSTTDictation',
    'DISPID_SPPEngineConfidence', 'SP_VISEME_6', 'SPWORDTYPE',
    'eLEXTYPE_PRIVATE3', 'SPEI_PROPERTY_NUM_CHANGE', 'SRAInterpreter',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SGRsCount',
    'SPEI_HYPOTHESIS', 'eWORDTYPE_ADDED', 'SRARoot',
    'DISPID_SAEventHandle', 'SGRSTTTextBuffer', 'DISPID_SRCState',
    'DISPIDSPTSI_SelectionLength', 'SPCT_SUB_DICTATION',
    'DISPID_SDKSetLongValue', 'SP_VISEME_17', 'DISPID_SVEBookmark',
    'DISPID_SPEs_NewEnum', 'ISpRecognizer', 'DISPID_SPPsCount',
    'DISPID_SVSkip', 'SDTReplacement', 'SECFEmulateResult',
    'SAFT24kHz8BitStereo', 'DISPID_SpeechMMSysAudio',
    'ISpStreamFormat', 'DISPID_SDKEnumValues',
    'DISPID_SDKDeleteValue', 'SPPS_Interjection', 'SP_VISEME_12',
    'SPGS_ENABLED', 'eLEXTYPE_PRIVATE5',
    'DISPID_SREmulateRecognition', 'SDTLexicalForm',
    'ISpXMLRecoResult',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SGRSTTWord',
    'ISpeechPhraseAlternate', 'SpeechPartOfSpeech',
    'SAFT8kHz8BitMono', 'SPRULE', 'eLEXTYPE_PRIVATE1',
    'SPEI_RECO_STATE_CHANGE', 'SREAllEvents', 'DISPID_SLGetWords',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SOTCGetDataKey',
    'SRTExtendableParse', 'SPVPRIORITY', 'DISPID_SpeechObjectTokens',
    'SPINTERFERENCE', 'SREFalseRecognition',
    'DISPID_SPERequiredConfidence', 'SAFTGSM610_8kHzMono',
    'DISPID_SOTCDefault', 'DISPID_SpeechFileStream',
    'ISpeechAudioBufferInfo', 'SPPHRASEELEMENT',
    'DISPID_SpeechGrammarRule', 'SpCompressedLexicon',
    'ISpeechPhraseInfoBuilder', 'DISPID_SVVoice',
    'DISPID_SOTMatchesAttributes', 'SVSFUnusedFlags',
    'DISPID_SGRSAddRuleTransition', 'ISpeechPhoneConverter',
    'SP_VISEME_9', 'DISPID_SPARecoResult', '_SPAUDIOSTATE',
    'DISPID_SPRFirstElement', 'SpeechLexiconType',
    'SAFT8kHz16BitStereo', 'DISPID_SPIReplacements',
    'DISPID_SLGenerationId', 'SPSFunction', 'SGDSActive',
    'DISPID_SRGRules', 'DISPID_SVAlertBoundary', 'DISPID_SLWsCount',
    'DISPID_SRRAudioFormat', 'SpeechCategoryAudioOut',
    'SPVOICESTATUS', 'SPSHT_EMAIL', 'SAFTCCITT_uLaw_22kHzMono',
    'SVP_3', 'SRTReSent', 'DISPID_SBSSeek', 'SPXRO_Alternates_SML',
    'DISPID_SGRAddResource', 'DISPID_SGRSRule',
    'SpeechWordPronounceable', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SWFEFormatTag', 'DISPID_SRGetFormat',
    'SpPhraseInfoBuilder', 'DISPID_SRCEPhraseStart',
    'SpeechAudioProperties', 'SAFT24kHz16BitStereo', 'SPGRAMMARSTATE',
    'SpeechAudioState', 'SPSLMA', 'SpeechCategoryPhoneConverters',
    'DISPID_SPCIdToPhone', 'DISPID_SPANumberOfElementsInResult',
    'ISpRecognizer3', 'DISPID_SGRAddState', 'SRSInactiveWithPurge',
    'SVEBookmark', 'ISpeechAudio', 'SPLO_STATIC',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SRGState',
    'DISPID_SRCRequestedUIType', 'DISPID_SpeechLexiconPronunciation',
    'SpMMAudioIn', 'SLODynamic', 'SAFT22kHz16BitStereo',
    'eLEXTYPE_PRIVATE20', 'DISPID_SVEVoiceChange',
    'DISPID_SPIAudioSizeTime', 'DISPID_SDKCreateKey',
    'SAFT11kHz16BitMono', 'DISPID_SRCCreateResultFromMemory',
    'ISpeechWaveFormatEx', 'SPCS_ENABLED', 'SAFTExtendedAudioFormat',
    'DISPID_SPPChildren', 'SRAExport', 'DISPID_SGRSTPropertyName',
    'SPSNotOverriden', 'SPAS_RUN', 'DISPID_SVSpeak', 'SVP_20',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SRGDictationLoad',
    'SRERecognition', 'SP_VISEME_21', 'SpPhoneConverter',
    'SP_VISEME_0', '_ISpeechRecoContextEvents', 'SPEI_REQUEST_UI',
    'SVP_19', 'SpeechGrammarRuleStateTransitionType', 'SPAR_Medium',
    'SpeechGrammarTagDictation', 'SAFT12kHz16BitMono',
    'SPEI_START_SR_STREAM', 'DISPID_SGRsDynamic',
    'SpeechAudioFormatGUIDText', 'SDTAudio', 'IEnumString',
    'DISPID_SOTs_NewEnum', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SGRSAddSpecialTransition', 'SPAR_High', 'SRADynamic',
    'DISPID_SRCEHypothesis', 'SPPS_RESERVED2',
    'DISPID_SRCEPropertyStringChange', 'SAFT11kHz16BitStereo',
    'DISPID_SGRSAddWordTransition', 'SP_VISEME_16',
    'SAFTCCITT_ALaw_11kHzMono',
    'SpeechPropertyNormalConfidenceThreshold',
    'SpeechRetainedAudioOptions', 'DISPID_SVSLastResult',
    'ISequentialStream', 'SREStreamEnd', 'SP_VISEME_5',
    'SPAR_Unknown', 'DISPID_SDKEnumKeys', 'SPDATAKEYLOCATION',
    'SPEI_MIN_TTS', 'SVSFVoiceMask', 'DISPID_SFSClose', 'SPSModifier',
    'SPAS_CLOSED', 'DISPID_SLPsItem', 'STCInprocHandler',
    'SAFTCCITT_uLaw_11kHzMono', 'eLEXTYPE_PRIVATE12', 'SRCS_Disabled',
    'SDKLLocalMachine', 'SAFTGSM610_44kHzMono', 'SPBO_TIME_UNITS',
    'DISPID_SVSCurrentStreamNumber', 'SPRECOCONTEXTSTATUS',
    'ISpeechRecoResultTimes', 'SVF_Stressed', 'SPEI_SR_RETAINEDAUDIO',
    'SECNormalConfidence', 'SpeechRuleState', 'DISPID_SRCESoundEnd',
    'SLOStatic', 'SGSEnabled', 'SWTDeleted', 'DISPID_SADefaultFormat',
    'DISPID_SRSAudioStatus', 'DISPID_SOTsItem', 'SECLowConfidence',
    'SPXRO_SML', 'SpSharedRecognizer',
    'DISPID_SPPBRestorePhraseFromMemory',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPLOADOPTIONS', 'SPVPRI_NORMAL',
    'SpStream', 'ISpRecoResult', 'DISPID_SRCEPropertyNumberChange',
    'SPWORDPRONUNCIATION', 'SPGS_DISABLED', 'SPVPRI_OVER', 'SVPAlert',
    'SPSHORTCUTTYPE', 'SVP_4', 'SSFMOpenReadWrite',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPCONTEXTSTATE',
    'DISPID_SRState', 'SPEI_PHONEME', 'DISPID_SPIStartTime', 'SVP_10',
    'SAFTCCITT_ALaw_22kHzStereo', 'ISpeechLexiconPronunciation',
    'SpeechCategoryRecoProfiles', 'DISPID_SpeechLexicon',
    'Speech_Max_Pron_Length', '_RemotableHandle',
    'DISPID_SVEStreamEnd', 'SVP_18', 'DISPID_SPRulesCount',
    'DISPID_SWFEAvgBytesPerSec', 'SPVPRI_ALERT', 'SECFIgnoreCase',
    'DISPID_SASState', 'SPEI_MAX_SR',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SVResume',
    'SPEI_SOUND_END', 'STSF_AppData', 'ISpeechPhraseRule',
    'SGRSTTWildcard', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SVSFNLPSpeakPunc', 'SGSDisabled', 'SpeechGrammarWordType',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SpeechPhraseRules',
    'ISpeechPhraseElement', 'DISPID_SVRate', 'ISpDataKey',
    'SpInProcRecoContext', 'SREAudioLevel',
    'SWPUnknownWordPronounceable', 'SpeechVisemeFeature',
    'DISPID_SRCResume', 'DISPID_SDKGetStringValue', 'SPAO_NONE',
    'SPRST_INACTIVE', 'Speech_StreamPos_Asap', 'SAFT44kHz16BitStereo',
    'DISPID_SASetState', 'DISPID_SOTGetDescription', 'SPSHT_OTHER',
    'DISPID_SVEEnginePrivate', 'SPEI_SR_PRIVATE',
    'ISpeechLexiconPronunciations', 'ISpeechRecoGrammar',
    'SPCT_SLEEP', 'DISPID_SPEEngineConfidence', 'ISpPhraseAlt',
    'SpFileStream', 'SVEPhoneme', 'DISPID_SpeechVoice',
    'ISpeechRecognizer', 'SpeechAddRemoveWord', 'DISPID_SGRsFindRule',
    'DISPID_SPPId', 'SVEEndInputStream',
    'DISPID_SVSInputSentenceLength', 'SAFT48kHz8BitMono',
    'DISPID_SVPause', 'SPEI_RESERVED1', 'SPSUnknown',
    'SAFTGSM610_22kHzMono', 'DISPID_SRRGetXMLErrorInfo',
    'SpeechMicTraining', 'SpeechLoadOption',
    'SpTextSelectionInformation', 'DISPID_SpeechCustomStream',
    'DISPID_SRSetPropertyNumber', 'DISPID_SPEDisplayAttributes',
    'DISPID_SpeechObjectTokenCategory', 'SPLO_DYNAMIC',
    'SVF_Emphasis', 'SpNullPhoneConverter', 'DISPID_SpeechAudio',
    'DISPID_SpeechLexiconProns', 'SAFTNonStandardFormat',
    'DISPID_SRCEventInterests', 'ISpeechPhraseInfo',
    'SAFTADPCM_44kHzStereo', 'eLEXTYPE_PRIVATE8', 'tagSTATSTG',
    'SPPHRASE', 'SECFIgnoreWidth', 'SpeechRuleAttributes',
    'SpeechEmulationCompareFlags', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRAudioInputStream', 'SpeechVoiceSpeakFlags',
    ...
    'SpeechCategoryAppLexicons', 'DISPID_SRRTimes',
    ...
    'DISPID_SAFSetWaveFormatEx', 'SpeechTokenContext',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SREAdaptation',
    'eLEXTYPE_USER', 'DISPID_SVEStreamStart',
    'DISPID_SVGetAudioInputs', 'SVSFDefault', 'SVP_11',
    'SDA_Two_Trailing_Spaces', 'DISPID_SDKGetlongValue',
    'ISpStreamFormatConverter', 'DISPID_SpeechRecoContext',
    'DISPID_SPRDisplayAttributes', 'SRTSMLTimeout',
    'eWORDTYPE_DELETED', 'DISPID_SRCCreateGrammar',
    'Speech_Max_Word_Length', 'SPBOOKMARKOPTIONS',
    'DISPID_SVAudioOutputStream', 'SAFT11kHz8BitMono',
    'SAFTCCITT_ALaw_8kHzMono', 'tagSPPROPERTYINFO',
    'DISPID_SRAudioInput', 'SpeechTokenShellFolder',
    'DISPID_SPEsItem', 'SpShortcut', 'eLEXTYPE_PRIVATE4', 'SVF_None',
    'ISpeechXMLRecoResult', 'SAFTTrueSpeech_8kHz1BitMono',
    'SGRSTTRule', 'SRESoundEnd', 'SPPHRASEPROPERTY',
    'DISPID_SOTsCount', 'DISPID_SRRTTickCount', 'SVP_1',
    'ISpeechPhraseAlternates', 'SSTTTextBuffer',
    'DISPID_SPRuleConfidence', 'SPEI_RESERVED6',
    'DISPID_SASNonBlockingIO', 'DISPID_SPISaveToMemory', 'SASRun',
    'SLTApp', 'SPSERIALIZEDPHRASE', 'DISPID_SRProfile',
    'SPXMLRESULTOPTIONS', 'DISPID_SCSBaseStream',
    'DISPID_SPCPhoneToId', 'SDTProperty', 'SpeechDiscardType',
    'SREPropertyNumChange', 'DISPID_SVIsUISupported',
    'DISPID_SGRsCommit', 'DISPID_SRRPhraseInfo',
    'DISPID_SpeechAudioBufferInfo', 'SECFDefault',
    'DISPID_SRCVoicePurgeEvent', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPEI_VISEME', 'SSSPTRelativeToEnd', 'SPRST_NUM_STATES',
    'SRATopLevel', 'DISPID_SOTSetId', 'SVP_14', 'SP_VISEME_4',
    'DISPID_SPPValue', 'DISPID_SPRuleNumberOfElements',
    'SpeechAudioFormatGUIDWave', 'SVSFParseAutodetect',
    'SAFT8kHz8BitStereo', 'DISPID_SASCurrentDevicePosition',
    'SAFT12kHz8BitMono', 'DISPID_SPPParent', 'STCLocalServer',
    'DISPIDSPTSI_ActiveOffset', 'ISpRecognizer2', 'DISPID_SRRAudio',
    'SRERequestUI', '_ISpeechVoiceEvents',
    ...
    'SpeechDisplayAttributes', 'eLEXTYPE_VENDORLEXICON',
    ...
    'SPPARTOFSPEECH', 'SVP_9', 'DISPID_SLPsCount', 'DISPID_SRCVoice',
    'SAFT48kHz8BitStereo', 'SPPS_RESERVED1',
    'DISPID_SpeechPhraseElement', 'DISPID_SOTIsUISupported',
    'DISPID_SpeechGrammarRuleStateTransition', 'ISpPhoneConverter',
    'SPBO_PAUSE', 'DISPID_SFSOpen', 'SGSExclusive', 'DISPID_SPRText',
    ...
    'DISPID_SVSLastBookmark', 'SVEStartInputStream',
    'eLEXTYPE_LETTERTOSOUND', 'SRTStandard', 'DISPID_SRSClsidEngine',
    'SINoSignal', 'SDKLCurrentUser', 'DISPID_SVSLastBookmarkId',
    'DISPID_SRCRetainedAudioFormat', 'SVESentenceBoundary',
    'DISPID_SGRsCommitAndSave', 'eLEXTYPE_RESERVED7',
    'DISPID_SWFEExtraData', 'DISPID_SGRSTWeight',
    'DISPID_SRCEAdaptation', 'SPINTERFERENCE_NOISE', 'SRAONone',
    'ISpStream', 'SPEI_RECO_OTHER_CONTEXT', 'ISpRecoGrammar2',
    'SPEI_VOICE_CHANGE', 'DISPID_SVStatus', 'DISPID_SVDisplayUI',
    'DISPID_SVGetAudioOutputs', 'SPSMF_UPS', 'DISPID_SOTRemove',
    'SPPS_Unknown', 'SPPHRASERULE', 'SPINTERFERENCE_TOOLOUD',
    'SGRSTTDictation', 'DISPID_SPRulesItem', 'SAFT8kHz16BitMono',
    'SPPS_LMA', 'ISpeechRecoContext', 'DISPID_SRRAlternates',
    'Speech_Default_Weight', 'SGPronounciation', 'SPEI_WORD_BOUNDARY',
    'SPDKL_CurrentConfig', 'SPCS_DISABLED',
    'DISPID_SRCEEnginePrivate', 'SpeechTokenKeyFiles',
    'SpeechTokenValueCLSID', 'DISPID_SRCBookmark',
    'DISPID_SPRuleParent', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SRGDictationUnload', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SPRuleChildren',
    'DISPID_SVEWord', 'SPPS_Function', 'SpObjectTokenCategory',
    'DISPID_SVSRunningState', 'SVEPrivate', 'SAFTADPCM_11kHzMono',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SRGRecoContext',
    'DISPID_SAFType',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPFM_OPEN_READONLY', 'SAFT22kHz16BitMono',
    'DISPID_SPIAudioSizeBytes', 'ISpVoice', 'SRSInactive',
    'SGLexicalNoSpecialChars', 'SVSFParseMask', 'eLEXTYPE_PRIVATE14',
    'DISPID_SPRuleId', 'DISPID_SRGetRecognizers', 'SP_VISEME_18',
    'SAFT24kHz16BitMono', 'DISPID_SVEViseme', 'SPEI_END_INPUT_STREAM',
    'SpeechInterference', 'SSFMCreate', 'DISPID_SpeechPhoneConverter',
    'SRAORetainAudio', 'DISPID_SLGetGenerationChange',
    'ISpObjectToken', 'eLEXTYPE_RESERVED4',
    'DISPID_SpeechGrammarRules', 'DISPID_SGRSTs_NewEnum',
    'SpInprocRecognizer', 'DISPID_SLPLangId', 'ISpEventSource',
    'SP_VISEME_2', 'DISPID_SRCERecognitionForOtherContext',
    'SpeechVoiceEvents', 'SPSMF_SAPI_PROPERTIES', 'DISPID_SRIsShared',
    'SVSFIsFilename', 'DISPID_SWFESamplesPerSec',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'eLEXTYPE_PRIVATE10',
    'DISPID_SRGSetWordSequenceData', 'SLTUser',
    'SpeechCategoryRecognizers', 'SECFNoSpecialChars',
    'SECFIgnoreKanaType', 'DISPID_SRDisplayUI', 'SVEVoiceChange',
    'SPBO_NONE', 'ISpNotifySource', '__MIDL_IWinTypes_0009',
    'ISpeechPhraseReplacements', 'SPEI_INTERFERENCE',
    'DISPID_SLPPartOfSpeech', 'SPEI_MIN_SR', 'SRESoundStart',
    ...
    'SREBookmark', 'eLEXTYPE_PRIVATE15', 'eLEXTYPE_PRIVATE18',
    'SRSActive', 'SAFTADPCM_8kHzMono', 'DISPID_SGRSTPropertyValue',
    'SpeechRunState', 'SVSFParseSsml', 'DISPID_SVSpeakStream',
    'SDTAll', 'DISPID_SRRecognizer', 'SPEI_TTS_PRIVATE',
    'SPWT_PRONUNCIATION', 'SPRECORESULTTIMES',
    'DISPID_SPAStartElementInResult', 'SPEI_RESERVED3',
    'DISPID_SABIMinNotification', 'SpeechRecoContextState',
    'ISpRecoContext', 'DISPID_SGRClear', 'DISPID_SMSSetData',
    'SGDSActiveWithAutoPause', 'SpeechGrammarState',
    'DISPID_SVEPhoneme', 'SGDisplay', 'DISPID_SpeechDataKey',
    'DISPID_SVEAudioLevel', 'ISpeechMemoryStream',
    'SpeechDataKeyLocation', 'DISPID_SWFEBlockAlign',
    'SSSPTRelativeToCurrentPosition', 'SGDSInactive', 'SVEAudioLevel',
    'DISPID_SRSCurrentStreamPosition', 'ISpEventSink', 'SPEVENTENUM',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SRGCommit',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SBSRead',
    'SpeechUserTraining', 'SpMMAudioEnum', 'DISPID_SDKGetBinaryValue',
    'DISPID_SGRName', 'DISPID_SPRsCount', 'DISPID_SpeechLexiconWords',
    'DISPID_SRIsUISupported', 'SAFTGSM610_11kHzMono', 'DISPIDSPRG',
    'SRSEDone', 'SVP_8', 'SAFT11kHz8BitStereo', 'DISPID_SPAsItem',
    'DISPID_SpeechWaveFormatEx', 'SPEVENTSOURCEINFO', 'SPRS_ACTIVE',
    'DISPID_SpeechPhraseInfo', 'ISpProperties',
    'SpeechEngineProperties', 'DISPID_SMSADeviceId',
    ...
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SpeechObjectToken',
    'SP_VISEME_1', 'SVSFPersistXML', 'eLEXTYPE_PRIVATE19',
    'SP_VISEME_8', 'SPRULESTATE', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SRCSetAdaptationData', 'SGRSTTEpsilon',
    'SPSTREAMFORMATTYPE', 'ISpMMSysAudio', 'SRADefaultToActive',
    'DISPID_SOTId', 'DISPID_SGRSTType', 'SPSEMANTICFORMAT',
    'DISPID_SLRemovePronunciation', 'DISPID_SPEAudioTimeOffset',
    'SVEViseme', 'SPEI_RESERVED2', 'SREPrivate',
    'DISPIDSPTSI_ActiveLength', 'SpeechAudioFormatType',
    'DISPID_SPEsCount', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SPEAudioSizeTime', 'SVSFIsXML', 'DISPID_SPCLangId',
    'ISpRecoGrammar', 'SPAS_PAUSE', 'DISPID_SASFreeBufferSpace',
    'SpeechAllElements', 'DISPID_SVEventInterests', 'SVP_6',
    'SpeechBookmarkOptions', 'SVEWordBoundary', 'SVP_13',
    'SVSFNLPMask', 'SVPNormal', 'SASClosed', 'SFTSREngine',
    'SPLEXICONTYPE', 'eLEXTYPE_RESERVED10', 'SPWAVEFORMATTYPE',
    'ISpAudio', 'DISPID_SPRuleName', 'WAVEFORMATEX',
    'SpeechAudioVolume', 'SPRS_INACTIVE', 'DISPID_SpeechRecognizer',
    'SAFTADPCM_11kHzStereo', 'DISPID_SPRuleFirstElement',
    'SPCATEGORYTYPE', 'SpeechFormatType',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SVGetVoices',
    'SpObjectToken', 'SpVoice', 'DISPID_SLWPronunciations',
    'eLEXTYPE_PRIVATE11', 'SVPOver', 'SRTAutopause',
    'DISPID_SRCEAudioLevel', 'SpeechEngineConfidence',
    'SPEI_SR_AUDIO_LEVEL', 'SP_VISEME_20', 'SAFTText',
    'SPSHT_NotOverriden', 'SREPropertyStringChange',
    'DISPID_SVSpeakCompleteEvent', 'ISpeechVoice', 'SFTInput',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SPRsItem',
    ...
    'DISPID_SpeechPhraseProperty', 'SPWF_SRENGINE',
    'DISPID_SPRNumberOfElements', 'DISPID_SLPSymbolic',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SPIRule',
    'SpeechDictationTopicSpelling', 'SPRECOGNIZERSTATUS',
    'DISPID_SPILanguageId', 'ISpResourceManager', 'SPFILEMODE',
    'SITooLoud', 'ISpRecoCategory', 'SpeechTokenKeyAttributes',
    'DISPID_SVESentenceBoundary', 'SpeechRecoProfileProperties',
    'DISPID_SRCERecognition', 'DISPID_SPEActualConfidence',
    'DISPID_SOTCId', 'DISPID_SABufferInfo', 'SP_VISEME_19',
    'ISpeechAudioFormat', 'DISPID_SRRSetTextFeedback',
    'SPPHRASEREPLACEMENT', 'SAFT16kHz8BitStereo',
    'DISPID_SPIGetDisplayAttributes', 'ISpeechPhraseElements',
    'DISPID_SGRSTsItem', 'DISPID_SRCreateRecoContext', 'SDTRule',
    'SpPhoneticAlphabetConverter', 'SPSNoun', 'DISPID_SVSPhonemeId',
    'DISPID_SPAsCount', 'ISpeechRecoResult2', 'DISPID_SRGId',
    'DISPID_SRCEBookmark', 'SPPS_Noun', 'DISPID_SGRSTransitions',
    'SPSHORTCUTPAIR', 'SPSInterjection', 'SPSERIALIZEDRESULT',
    'DISPID_SRCEInterference', 'SRSEIsSpeaking', 'SP_VISEME_3',
    'DISPID_SPRs_NewEnum', 'SDKLCurrentConfig', 'SSTTWildcard',
    'SREHypothesis', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SPPName', 'DISPID_SWFEChannels', 'DISPID_SPAs_NewEnum',
    'DISPID_SRRSaveToMemory', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SpeechRecoResult', 'SREInterference',
    'IEnumSpObjectTokens', 'ISpGrammarBuilder', 'LONG_PTR',
    'SPSSuppressWord', 'DISPID_SRCRecognizer',
    'SpeechRegistryUserRoot', 'SpeechRecoEvents',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SRCERecognizerStateChange',
    'SPEI_SOUND_START', 'SAFTADPCM_22kHzMono', 'STCRemoteServer',
    'ISpeechLexiconWord', 'SVP_15', 'SpMMAudioOut',
    'DISPID_SRCRetainedAudio', 'eLEXTYPE_APP',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SABIEventBias',
    'Speech_StreamPos_RealTime', 'STSF_CommonAppData', 'SRCS_Enabled',
    'DISPID_SRCEStartStream', 'SPRECOSTATE', 'SPWORDLIST',
    'DISPID_SMSALineId', 'DISPID_SOTCreateInstance',
    'DISPID_SABIBufferSize', 'SPSEMANTICERRORINFO', 'SVP_0',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SPEPronunciation',
    'ISpeechPhraseProperty', 'SAFTCCITT_uLaw_22kHzStereo',
    'eLEXTYPE_RESERVED8', 'SpeechPropertyLowConfidenceThreshold',
    'SAFT16kHz16BitStereo', 'SDKLDefaultLocation', 'SPRST_ACTIVE',
    'ISpeechPhraseRules', 'DISPID_SVAudioOutput',
    'DISPID_SPPFirstElement', 'DISPID_SRGSetTextSelection',
    'DISPID_SGRId', 'SPPS_Modifier', 'SPINTERFERENCE_LATENCY_WARNING',
    'SPEI_TTS_BOOKMARK', 'SPDKL_DefaultLocation', 'ISpNotifySink',
    'DISPID_SOTDataKey', 'DISPID_SRGCmdLoadFromFile', 'SPWT_LEXICAL',
    'eLEXTYPE_USER_SHORTCUT', 'SP_VISEME_7', 'SPEI_SR_BOOKMARK',
    'SPSVerb', 'SAFT12kHz16BitStereo', 'DISPID_SPACommit',
    'DISPID_SGRSTNextState', 'SPAUDIOSTATUS',
    'SpeechVoiceSkipTypeSentence', 'SVP_7', 'SpSharedRecoContext',
    'DISPID_SABufferNotifySize', 'SPWORDPRONOUNCEABLE',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPIDSPTSI', 'SASPause',
    'DISPID_SRCPause', 'DISPID_SpeechPhraseBuilder',
    'SVSFPurgeBeforeSpeak', 'DISPID_SPEDisplayText', 'SPAS_STOP',
    'SpeechRecognizerState', 'DISPID_SPPConfidence',
    'DISPID_SLAddPronunciation', 'ISpeechRecoResultDispatch',
    'SpCustomStream', 'DISPID_SGRAttributes', 'SPEI_ADAPTATION',
    'DISPID_SPPsItem', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SVPriority', 'SRAImport', 'SpResourceManager',
    'DISPID_SRRSpeakAudio', 'ISpeechObjectTokenCategory',
    'SpeechGrammarTagUnlimitedDictation', 'SpLexicon',
    'ISpeechCustomStream', 'ISpeechLexicon',
    'DISPID_SpeechGrammarRuleState', 'SWPUnknownWordUnpronounceable',
    'SP_VISEME_15', 'DISPID_SpeechRecoResult2',
    'DISPID_SAFGetWaveFormatEx', 'SPCT_DICTATION',
    'SpeechSpecialTransitionType', 'ISpeechObjectTokens',
    'DISPID_SAStatus', 'SVSFlagsAsync', 'SpeechCategoryAudioIn',
    ...
    'SPEI_MAX_TTS', 'SVP_2', 'SAFT24kHz8BitMono',
    'DISPID_SVSInputWordLength', 'SPFM_NUM_MODES', 'SVP_5',
    ...
    'DISPID_SRRGetXMLResult', 'SPEI_END_SR_STREAM',
    'ISpeechGrammarRuleStateTransition', 'eLEXTYPE_RESERVED9',
    'SPGS_EXCLUSIVE', 'SpeechWordType', 'SRERecoOtherContext',
    'DISPID_SRSSupportedLanguages', 'DISPID_SPAPhraseInfo',
    'UINT_PTR', 'SBOPause', 'SPFM_OPEN_READWRITE',
    'ISpObjectWithToken', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPWORD', 'SPINTERFERENCE_TOOSLOW', 'ISpNotifyTranslator',
    'SREStreamStart', 'SPADAPTATIONRELEVANCE', 'SREPhraseStart',
    'SAFT22kHz8BitStereo', 'STSF_FlagCreate', 'DISPID_SAVolume',
    'SPEI_SENTENCE_BOUNDARY', 'SPEI_PHRASE_START', 'ISpRecoContext2',
    'DISPID_SRRTLength', 'SpeechRecognitionType',
    'eLEXTYPE_PRIVATE13', 'SAFTNoAssignedFormat',
    'SpeechPropertyResponseSpeed', 'SPPROPERTYINFO',
    'DISPID_SGRSTsCount', 'DISPID_SVWaitUntilDone',
    'ISpeechGrammarRules', 'SPINTERFERENCE_TOOFAST', 'DISPID_SLWType',
    'SVP_17', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SLGetPronunciations', 'SPVISEMES', 'SPPS_Verb',
    'DISPID_SGRSTText', 'DISPID_SLWsItem', 'STSF_LocalAppData',
    'DISPID_SPIProperties', 'DISPID_SPIGetText', 'DISPID_SLWLangId',
    'SpeechTokenKeyUI', 'SVEAllEvents', 'SDA_No_Trailing_Space',
    'SAFT32kHz8BitStereo', 'SAFT32kHz16BitStereo',
    'DISPID_SLPPhoneIds', 'ISpeechAudioStatus', 'SAFT48kHz16BitMono',
    'SPPS_Noncontent', 'DISPID_SRGCmdSetRuleIdState',
    'SpeechRegistryLocalMachineRoot', 'eLEXTYPE_PRIVATE17',
    'DISPID_SRRRecoContext', 'DISPID_SRCCmdMaxAlternates', 'SVP_21',
    'ISpeechObjectToken', 'SpeechGrammarTagWildcard',
    'DISPID_SOTRemoveStorageFileName',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SSFMOpenForRead',
    'eLEXTYPE_PRIVATE16', 'DISPID_SRGetPropertyNumber',
    'DISPID_SRGetPropertyString', 'SDTPronunciation',
    'DISPID_SGRsItem', 'ISpeechRecognizerStatus', 'SASStop',
    'SPAUDIOSTATE', 'SPPS_RESERVED4', 'SPBO_AHEAD', 'DISPID_SBSWrite',
    'DISPID_SWFEBitsPerSample', 'STCAll', 'SPDKL_CurrentUser',
    'SPWF_INPUT', 'SpeechStreamSeekPositionType',
    'SAFT12kHz8BitStereo', 'SAFT32kHz8BitMono', 'SPEVENT',
    'DISPID_SMSAMMHandle', 'SPBINARYGRAMMAR', 'ISpLexicon',
    'SPEI_RECOGNITION', 'ISpShortcut',
    'DISPID_SVSInputSentencePosition', 'ISpeechPhraseProperties',
    'DISPID_SRCERequestUI', 'SDTDisplayText',
    'DISPID_SpeechPhraseReplacements', 'SPAUDIOOPTIONS',
    'SWPKnownWordPronounceable', 'DISPID_SpeechMemoryStream',
    'SAFT44kHz16BitMono', 'SPSHORTCUTPAIRLIST',
    'DISPID_SPERetainedStreamOffset', 'ISpeechBaseStream', 'SVP_16',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPWT_DISPLAY',
    'SPGRAMMARWORDTYPE', 'SpeechVoiceCategoryTTSRate',
    'SPTEXTSELECTIONINFO', 'ISpeechDataKey', 'SpeechVisemeType',
    'DISPID_SDKSetStringValue', 'DISPID_SpeechLexiconWord',
    'DISPID_SPIEnginePrivateData', 'SP_VISEME_10',
    'SPAO_RETAIN_AUDIO', 'SpeechTokenIdUserLexicon', 'SREStateChange',
    'eLEXTYPE_PRIVATE7', 'SP_VISEME_14',
    'DISPID_SRGDictationSetState', 'DISPID_SVGetProfiles', 'SPAR_Low',
    'ISpeechTextSelectionInformation',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SINoise',
    'ISpeechGrammarRuleState', 'SAFT32kHz16BitMono',
    'SECHighConfidence', 'SPCT_COMMAND', 'DISPID_SBSFormat',
    'SPRST_INACTIVE_WITH_PURGE', 'SPCT_SUB_COMMAND', 'DISPID_SLWWord',
    'SpMemoryStream', 'SP_VISEME_13', 'SAFT16kHz8BitMono',
    'DISPID_SpeechPhraseElements', 'DISPID_SLPType',
    'SpeechCategoryVoices', 'SGLexical', 'SPINTERFERENCE_TOOQUIET',
    'SITooFast', 'DISPID_SDKDeleteKey', 'DISPID_SAFGuid',
    'DISPID_SpeechPhraseProperties', 'IInternetSecurityManager',
    'SRTEmulated', 'DISPID_SRGReset', 'DISPID_SRGIsPronounceable',
    'SPFM_CREATE_ALWAYS', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SpeechPhraseAlternate', 'SVSFParseSapi', 'SpAudioFormat',
    'eLEXTYPE_PRIVATE9', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SDKSetBinaryValue', 'STCInprocServer', 'SAFTDefault',
    'DISPID_SGRSTRule', 'DISPID_SRStatus', 'SPSHT_Unknown', 'IStream',
    'ISpeechVoiceStatus', 'SPEI_UNDEFINED', 'DISPID_SVVolume',
    'DISPID_SpeechVoiceEvent', 'SPPS_RESERVED3',
    'DISPID_SGRSTPropertyId', 'SPEI_RESERVED5', 'SITooQuiet',
    'ISpObjectTokenCategory', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SMSGetData', 'SAFTADPCM_44kHzMono',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SRSNumberOfActiveRules'
]

_check_version('1.1.14', 1778722758.441166)
